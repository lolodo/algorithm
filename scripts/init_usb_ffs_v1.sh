...
echo "file composite.c +p" > /sys/kernel/debug/dynamic_debug/control
echo "file configfs.c +p" > /sys/kernel/debug/dynamic_debug/control
echo "file f_fs.c +p" > /sys/kernel/debug/dynamic_debug/control
