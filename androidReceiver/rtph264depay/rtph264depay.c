...
#include <stdio.h>
#include <string.h>
static const unsigned char sync_bytes[] = {0, 0, 0, 1 };
...
static void
gst_rtp_h264_depay_handle_nal (GstRtpH264Depay * rtph264depay, unsigned char *nal,
...
static GstBuffer *
gst_rtp_h264_depay_process (void *buffer, int size, bool marker)
{
	char *payload;
